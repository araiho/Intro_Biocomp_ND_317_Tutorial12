...
fit1=optim(Guess, nllike1, x=subChicks$weight, y=subChicks$feed)
fit2=optim(Guess, nllike2, x=subChicks$weight, y=subChicks$feed)
fit1$value
fit2$value
...
The p-value given by the model is 1 (not statistically significant), so we fail to reject the null hypothesis. Therefore, feeding the chicks the **soybean or the sunflower seeds** doesn't change the **chick's weight.**