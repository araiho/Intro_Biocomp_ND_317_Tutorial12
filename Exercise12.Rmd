...
```{r chi-squared}
pval = pchisq(q=(2*(fitLinear$value-fitNull$value)), df=1,
             lower.tail = FALSE)
```

### Interpreting the Results

The p-value for the chi-squared test is 1. Therfore, we fail to reject the null hypothesis; *there is no statistically significant difference between weight among the food types soy and sunflower.*